                            ...
                            <div>
                                <form className="theme-form">
                                    ...
                                    <div className="bottom-sec">
                                        ...
                                        <a href="#" className="ms-auto forget-password">forget password?</a>
                                    </div>
                                ...
                                <div className="connect-with">
                                    ...
                                    <div className="no-account-blk"><p>Don't have an account? <NavLink to="/Signup">Sign Up</NavLink></p></div>
                                </div>
                            </div>
                        </div>
                    </div>
