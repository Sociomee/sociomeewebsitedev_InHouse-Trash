                            ...
                            <div>
                                <form className="theme-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="Write your username here"/>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="input-block">
                                          <input type={passwordShown ? "text" : "password"} className="form-control" placeholder="Enter your password here"/>
