        ...
        return (
            <>
                <div className="media-images-blk mp-product-list-block">
                    <NavLink to="/MpDetail"><img className="gallery-img" src={props.srcImg} alt="" /></NavLink>
                    <div className="text-gallery">
                        <div className="top-gallery-cont">
                            <p><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="iw-14 ih-14"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg> {props.viewBoxName}</p>
                    ...
                    <div className="content-mp-block">
                        <h4><NavLink to="/MpDetail">{props.h4Name}</NavLink></h4>
                        <h5><span className="green">{props.h5Nmae}</span> <b>{props.price}</b></h5>
                        <p><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="iw-11 ih-11"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>{props.location}</p>
                    </div>
                </div>
            </>
        )
                    ...
                    <div className="container-fluid section-t-space px-0">
                        <Row>
                            <Col xl="3" lg="4" md="6" sm="6"  >
                                <RowCardData
                                    srcImg={"assets/images/mp-1.jpg"}
                                    viewBoxName={120}
                                    h4Name={"SAF Love Couple Valentine Love Couple"}
                                    h5Nmae={"Home Decoration"}
                                    price={"$3000"}
                                    location={" 813 Howard Street Oswego NY 131, London, UK"}
                                />
                            </Col>
                            <Col xl="3" lg="4" md="6" sm="6"  >
                                <RowCardData
                                    srcImg={"assets/images/mp-2.jpg"}
                                    viewBoxName={150}
                                    h4Name={"Twin Love Couple Valentine Love Couple"}
                                    h5Nmae={"Living Area Decoration"}
                                    price={"$1000"}
