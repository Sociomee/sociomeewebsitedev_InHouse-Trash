...
export default function ArchivedShotz() {  
      ...
      <>
        ...
        <div className="page-body container-fluid profile-page">
          ...
          <div className="page-center">
            <div className="shotz-heading-block">
                <div className="row align-items-center">
                    ...
                    <div className="col-md-8">
                        <div className="right-setting shortz-buttons-block">
                            ...
                            <NavLink to="/Shotz" className="btn btn-light-green ms-3">All Shotz</NavLink>
                            <NavLink to="/ArchivedShotz" className="btn btn-light-green ms-3">Archived</NavLink>
                            <div className="setting-dropdown custom-dropdown arrow-none dropdown-sm ms-3">
                                <a href="#" className="btn btn-light-green" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">More ... <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="iw-14 ih-14 ms-1 mr-0"><polyline points="6 9 12 15 18 9"></polyline></svg></a>
                            ...
                            <div className="setting-dropdown custom-dropdown arrow-none dropdown-sm ms-3">
                                ...
                                <div className="dropdown-menu dropdown-menu-right custom-dropdown">
                                    <ul className="custom-drop-list-block">
                                        ...
                                        <li><a href="#">Science & Medicine</a></li>
            ...
            <div className="shotz-album shotz-mainalbum-block">
                <div className="row">
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div className="media-images-blk shotz-album-block">
                            ...
                            <div className="shotz-cont-blk">
                                <h4>Havy fast food breakfast</h4>
                                <p>12 Jul 2022, 09:00 PM</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div className="image-gallery">
                            <div className="row m-0">
                                <div className="col-xl-9 col-lg-8 p-0">
                                    ...
                                    <div className="shotz-model-block embed-responsive embed-responsive-16by9">
                                        {/* <img src="assets/images/shotz-2.jpg"/> */}
                                        <video  class="embed-responsive-item" controls controlsList="nodownload">
                                            <source src="assets/images/video/shotz-1.mp4" type="video/mp4"/>
                                        </video>
                                    </div>
                                    </div>
                                </div>
