            ...
            <div className="post-details">
                <div className="img-wrapper">
                    <div className="slider-section bizslider-sec">
                        ...
                        <Slider {...groupSettings} className="ratio_landscape default-space no-arrow">
                            {
                                groups?.suggestedGroups && groups?.suggestedGroups?.map((group) => {
                                    return <div key={group.id}>
                                        <div className="bizpage-block">
                                            <img src={group.coverPicUrl} />
                                            <h4>{group.name}</h4>
