                    ...
                    <div>
                        <div className="group-slide-box">
                            ...
                            <div className="group-content">
                                ...
                                <div className="people-likes matual-friend-sec m-0">
                                    <p className="m-0">Learn how to master your commun...</p>
                                </div>
                                <div className="group-buttons-blk">
                                    <a href="#" className="group-btn green-clr-btn">View Activity</a>
                                    <a href="#" className="group-btn">Unfollow</a>
                                </div>
                            </div>
                        </div>
                    </div>
