...
import { getUserBizPage } from '../../Services/Actions/BizPage/bizPageAction';
...
export default function Biz() {
    ...
    const [allBizPage, setAllBizPage] = useState('');

    // get user's biz page
    const { userBizPage } = useSelector(state => state.bizPageData)

    const dispatch = useDispatch();

    useEffect(() => {
        dispatch(getUserBizPage())
    }, [])

    useEffect(() => {
        setAllBizPage(userBizPage?.successResult?.rows)
    }, [userBizPage])
                                        ...
                                        allBizPage && allBizPage.map((bizPage) => {
                                            return <div>
                                                <div className="group-slide-box">
                                                    ...
                                                    <NavLink to={`/BizDetail/${bizPage.id}`} className="bizpagelink-blk"><img src="/assets/images/group-img-1.jpg" className="img-fluid group-img" />
                                                    <div className="group-adminprofile-blk">
                                                    <img src={bizPage.businessPageLogo && bizPage.businessPageLogo} />
                                                    </div>
                                                    </NavLink>
                                                    <div className="group-content">
                                                        ...
                                                        <div className="groupmember-blk">
                                                            <span><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="iw-10 ih-10"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg> Public Group</span>
                                                        </div>
                                                        <div className="likepost-follow-blk">
                                                            <p></p>
                                                            <p>42<span>Posts</span></p>
                                                            <p>{bizPage?.followerCount}<span>Followers</span></p>
                                                            <p></p>
                                                        </div>
                                                        <div className="group-buttons-blk">
                                                            <a href="/" className="group-btn">Like</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
