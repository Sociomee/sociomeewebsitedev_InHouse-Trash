                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-4 col-lg-4 col-12 order-lg-2">
                                    <div className="biz-user-pro-blk">
                                        ...
                                        <h5>PAGE NAME</h5>
                                        <p><svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" class="iw-10 ih-10"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> Addess</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-4 col-lg-4 col-12 order-lg-3">
                                    ...
                                    <div className="create-biz-btn"><a href="#" class="btn btn-primary green-clr-btn">Create Biz Page</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
