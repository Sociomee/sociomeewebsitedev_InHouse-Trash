                        ...
                        <div className="post-panel">
                            <div className="post-wrapper col-grid-box section-b-space">
                                ...
                                <div className="post-details">
                                    <div className="thought-post-details-block">
                                        <div className="thought-inner-cont"><span class="ti-quote-left"></span> The real test of character is how you treat someone who has no possibility of doing you any good.<span class="ti-quote-right"></span></div>
                                        <h4>- Pepper Johnson Potts</h4>
                                        <p>#thoughtoftheday</p>
                                    </div>
