...
export default function MyPollScheduled() {
  return (
    <>
      <Header></Header>
                          ...
                          <div className="post-details">
                            ...
                            <div className="mypoll-progress-innercont">
                              <div className="progress-inner-cont-blk">
                                ...
                                <div className="progress">
                                  <div className="progress-bar progress-bar-scheduled" role="progressbar" style={{ width: '30%' }} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                              </div>
                              <div className="progress-inner-cont-blk">
                                <div className="progress-contmypoll">
                                ...
                                <div className="progress">
                                  <div className="progress-bar progress-bar-scheduled" role="progressbar" style={{ width: '20%' }} aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                              </div>
                              <div className="progress-inner-cont-blk">
                                <div className="progress-contmypoll">
                                ...
                                <div className="progress">
                                  <div className="progress-bar progress-bar-scheduled" role="progressbar" style={{ width: '12%' }} aria-valuenow="12" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                              </div>
                              <div className="progress-inner-cont-blk">
                                <div className="progress-contmypoll">
                                ...
                                <div className="progress">
                                  <div className="progress-bar progress-bar-scheduled" role="progressbar" style={{ width: '50%' }} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="mypoll-analitics-block">
                              <div className="mypoll-analitics-header">
                                ...
                                <span className="">Scheduled for 8th Sep 2022</span>
                              </div>
                                  ...
                                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <div className="genage-progress-block">
                                      <div class="genage-progress-list-blk">
                                        ...
                                        <div class="progress">
                                          <div class="progress-bar progress-bar-genageloc" role="progressbar" style={{ width: '80%' }} aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </div>
                                      <div class="genage-progress-list-blk">
                                        <div className="genage-progress-cont-blk"><span>Female</span> <span>965</span></div>
                                        <div class="progress">
                                          <div class="progress-bar progress-bar-genageloc" role="progressbar" style={{ width: '50%' }} aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </div>
                                      <div class="genage-progress-list-blk">
                                        <div className="genage-progress-cont-blk"><span>Other</span> <span>365</span></div>
                                        <div class="progress">
                                          <div class="progress-bar progress-bar-genageloc" role="progressbar" style={{ width: '25%' }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <div className="genage-progress-block">
                                      <div class="genage-progress-list-blk">
                                        ...
                                        <div class="progress">
                                          <div class="progress-bar progress-bar-genageloc" role="progressbar" style={{ width: '30%' }} aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </div>
                                      <div class="genage-progress-list-blk">
                                        <div className="genage-progress-cont-blk"><span>20+ Years Old</span> <span>1.5k</span></div>
                                        <div class="progress">
                                          <div class="progress-bar progress-bar-genageloc" role="progressbar" style={{ width: '70%' }} aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </div>
                                      <div class="genage-progress-list-blk">
