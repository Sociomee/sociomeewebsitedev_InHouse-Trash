          ...
          <div className="page-center">
            ...
            <div className="container-fluid section-t-space px-0">
                <div className="gallery-page-section section-b-space">
                    <div className="custom-profile-buttons-header cust-border-bottom">
                        <div className="row align-items-center">
                            <div className="col-md-4">
                                <div className="card-title">
                                    <h3>My Podcast (162)</h3>
                                </div>
                            </div>
                            <div className="col-md-8">
                                <div className="right-setting">
                                    ...
                                    <a href="#" className="btn btn-outline-grey ms-3">Explore</a>
                                    <a href="#" className="btn btn-outline-green ms-3"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="iw-14 ih-14 mr-1"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg> Create / Upload</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="podcast-main-section">
                        <div className="row">
                            <div className="col-md-9">
                                <div className="mypodcast-list-section">
                                    <div className="podcast-list-block">
                                        <div className="heading-podcast-blk">
                                            <h3>My Top Podcast</h3>
                                            <NavLink to="/MyPodcastList" className="single-ancor-blk">See All →</NavLink>
                                        </div>
                                            ...
                                            <div>
                                                <div className="podcast-slide-box">
                                                    ...
                                                    <div className="podcast-content">
                                                        ...
                                                        <p><b>Price </b><i><span className="green">$14.00</span></i></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <div className="podcast-slide-box">
                                                    ...
                                                    <div className="podcast-content">
                                                        ...
                                                        <p><b>Price </b><i><span className="green">Free</span></i></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                            ...
                            <div className="col-md-3">
                                <div className="mypodcast-sideblock">
                                    <div className="card-custom-blk">
                                        <h3>Recently Played</h3>
                                        <div className="playingpodcast-blk">
                                            <img src="assets/images/podcast-side-cover.jpg"/>
                                    ...
                                    <div className="podcast-episode-blockmain">
                                        ...
                                        <div className="seeall-pod-btn">
                                            <a className="btn btn-primary" href="#">See All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
